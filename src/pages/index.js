            ...
            <Layout noGlobalNav>
                ...
                <div id="main">
                        ...
                        <div className="spotlight">
                            <div className="content">
                                <header className="major">
                                    <h2>About Me</h2>
                                    <p>
                                        I am a full-stack JavaScript developer with a PhD in computational particle
                                        physics and a love of web technologies. I have experience in setting up, using,
                                        teaching and administrating Linux systems; technical consultancy and content
                                        creation; science communication and education; and theatre production and
                                        performance.
                                    </p>
                                </header>
                                <p>
                                    This unique combination of technical and communication skills has led me through a
                                    number of interesting projects. Read more about them below, or if you have a need
                                    for this blend of know-how, don't hesitate to drop me a line.
                                </p>
                    ...
                    <section id="software" className="main special">
                        ...
                        <ul className="features">
                            <li>
                                ...
                                <p>
                                    Powered by a React frontend and a GraphQL backend, implementing a semi-permanent
                                    cache of the ticketing system's SOAP API.
                                </p>
                            </li>
                            <li>
                                ...
                                <p>
                                    A mobile app to deliver exhibit interpretation in British Sign Language for visitors
                                    to{" "}
                                    <a
                                        href="https://www.glasgowsciencecentre.org"
                                        target="_blank"
                                ...
                                <p>Implemented in React Native with videos using HLS for adaptive streaming.</p>
                            </li>
                            <li>
                                ...
                                <a href="https://github.com/cecilian-archives">https://github.com/cecilian-archives</a>
                            </li>
                        </ul>
                        <footer className="major">
                            <p>This site is still under extended construction, and this section is due a revamp!</p>
                            <ul className="actions">
                                <li>
                            ...
                            <div className="content">
                                <header className="major">
                                    ...
                                    <p>
                                        ...
                                        , mainly developing and delivering educational content for the{" "}
                                        <a href="https://twitter.com/uaecyberquest?lang=en">Cyber Quest</a> programme in
                                ...
                                <ul>
                                    <li>
                                        ...
                                        <a href="https://blockchain.bengalloway.io">content for technical workshops</a>{" "}
                                    ...
                                    <li>Leadership and technical training of teams of science communicators</li>
                        ...
                        <div className="spotlight">
                            <div className="content">
                                <header className="major">
                                    <h2>Science</h2>
                                    <p>
                                        I hold a Ph.D. in computational particle physics and an M.Sci. in Physics and
                                        Astronomy, both from the{" "}
                                ...
                                <p>
                                    ...
                                    <a href="https://theses.gla.ac.uk/8196/">
                                        Properties of charmonium and bottomonium from lattice QCD with very fine
                                        lattices
                                    </a>
                                    ", is available online, and I am a co-author on the following high-energy physics
                                    papers:
                                </p>
                                <ul>
                                    <li>
                    ...
                    <section id="contact" className="main special">
                        <header className="major">
                            <h2>Get In Touch</h2>
                            <p>Got a project you'd like to talk about? Always happy to chat.</p>
                        </header>
                        <footer className="major">
                            <ul className="actions">
                                <li>
                                    <a href="mailto:contact@bengalloway.io" className="button special">
                                        Contact Ben
                                    </a>
                                </li>
                            </ul>
